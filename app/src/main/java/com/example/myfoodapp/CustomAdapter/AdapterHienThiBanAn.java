...
import com.example.myfoodapp.ChonMonAn;
...
import com.example.myfoodapp.DTO.BanAnDTO;
import com.example.myfoodapp.DTO.GoiMonDTO;
import com.example.myfoodapp.DTO.MonAnDTO;
import com.example.myfoodapp.DTO.ThanhToanDTO;
import com.example.myfoodapp.R;
import com.example.myfoodapp.ThanhToanActivity;
import com.example.myfoodapp.TrangChuActivity;
        ...
        switch (id){
            ...
            case R.id.imGoiMon:
                if (monAnDTOs.size() > 0){
                    ...
                    ((TrangChuActivity)context).startActivityForResult(iChonMonAn,RESQUEST_CODE_THEMMONAN);
                }else {
            ...
            case R.id.imThanhToan:
                ...
                if (magoimon != 0){
                    if (thanhToanDTOS.size() > 0){
                        ...
                        ((TrangChuActivity)context).startActivityForResult(iThanhToan,RESQUEST_CODE_THANHTOAN);
                    }else
